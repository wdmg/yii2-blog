...
return [
    ...
    'No display language has been set for this tag. When saving, the current user language will be selected: {language}' => 'Для данной категории не задан язык отображения. При сохранении будет выбран текущий язык пользователя: {language}',
    'No display language has been set for this blog category. When saving, the current user language will be selected: {language}' => 'Для данного тэга не задан язык отображения. При сохранении будет выбран текущий язык пользователя: {language}',
    'View' => "Просмотр",
    'Edit' => "Изменить",
    'Delete' => "Удалить",
